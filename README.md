# This is the repository that contains all of the code for the Paper Where's WALL-E? A Comparison of the Extended Kalman Filter and Hybrid Inference for Pose Estimation in MAVs.
