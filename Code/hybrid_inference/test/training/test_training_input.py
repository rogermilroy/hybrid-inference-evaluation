...
class TestTraining(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.dataset = SyntheticPositionDataset(x0=torch.tensor([0., 0.1, 0., 0.1]),
                                                n_samples=100, sample_length=100,
                                                starting_point=0, seed=0)
        self.data_params = dict()
        self.data_params["train_samples"] = 5000
